...
cookbook 'jr-apache', github: "JacksonRiver/chef-jr-apache", tag: 'v0.1.4'
cookbook 'jr-php', github: "JacksonRiver/chef-jr-php", tag: 'v0.1.14'
cookbook 'jr-mysql', github: 'JacksonRiver/chef-jr-mysql', tag: 'v0.1.1'

cookbook "avahi", github: "benclark/chef-avahi", brandh: 'v0.2.1'
